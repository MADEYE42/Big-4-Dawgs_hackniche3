...
if __name__ == "__main__":
    search_url = "https://www.amazon.in/s?k=keyboard+for+laptop&i=computers&crid=24UWXTIEZE2WS&sprefix=keyboard+for+laptop%2Ccomputers%2C616&ref=nb_sb_noss_1"
    num_pages = 15

    products = scrape_amazon_products(search_url, num_pages)
    save_to_csv(products, filename="amazon_keyboards.csv")
