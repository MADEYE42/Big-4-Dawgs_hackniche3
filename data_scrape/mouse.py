...
if __name__ == "__main__":
    # URL to scrape - mouse for laptop search page
    url = "https://www.amazon.in/s?k=mouse+for+laptop&i=computers&crid=QQNS22Z3EW6Y&sprefix=mouse%2Ccomputers%2C202&ref=nb_sb_ss_ts-doa-p_1_5"
    ...
    # Save to CSV
    save_to_csv(products, filename="amazon_mouse_products.csv")
